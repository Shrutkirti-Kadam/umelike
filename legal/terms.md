...
## 1. Who operates umelike

UmeLike is operated by **[developer/legal entity name — must match the Google Play listing]**.

By creating or using an account, you agree to these Terms and the Privacy Policy.

---

## 2. Who can use umelike

You must be at least 18 years old and legally able to enter into this agreement where you live.

Your account is personal to you. Do not sell it, share access to it, or use someone else's account without permission.

---

## 3. Your profile and identity

Your profile must represent a real person: you.

Your photos must be of you, your age information must be truthful, and your profile must not intentionally impersonate or mislead other members.

You may choose an optional public display name subject to UmeLike's display-name rules. If you do not set one, UmeLike may show your first name publicly. Your full real name is kept private from ordinary member-facing profile paths.

If you use Selfie Verification, the selfie must be you performing the gesture UmeLike provides. Verification means UmeLike approved the profile-photo verification submission; it is not a background check and does not guarantee another member's identity, conduct, intentions, or safety.

---

## 4. How to treat other people
...
## 6. Platinum and paid features

Platinum purchase infrastructure exists in UmeLike, but real Google Play purchasing is not currently enabled in the present build.

Before paid subscriptions are launched, these Terms must be updated with the final price presentation, billing period, renewal terms, cancellation process, refund rules, entitlement behaviour, and any country-specific consumer disclosures.

If Platinum is sold through Google Play, Google Play will handle payment processing and the applicable Google Play purchase and refund rules will also apply.
...
## 8. Pausing and deleting your account

Pausing and deleting are different actions.

Pausing hides your profile from new discovery while preserving the account and existing social state according to the app's current behaviour.
...
The licence language in this section should be reviewed by counsel before publication so its scope, duration, sublicensing rights, and deletion consequences are legally appropriate.

---

## 10. UmeLike's service and intellectual property
...
If there is an emergency, contact the relevant emergency service rather than relying on UmeLike.

---

## 12. Availability and changes to the service

UmeLike may add, remove, modify, suspend, or discontinue features. The service may occasionally be unavailable because of maintenance, failures, provider outages, security events, or other causes.

Where applicable law requires notice, consent, refunds, or another remedy for a material change, UmeLike will follow those requirements.
...
**This section requires counsel before publication.**

UmeLike is provided subject to the rights and remedies that applicable law gives you. No wording in these Terms is intended to exclude a guarantee, remedy, or liability that cannot legally be excluded.

Any additional warranty disclaimer, limitation of liability, exclusion of indirect loss, liability cap, or allocation of risk should be added only after legal review for the countries in which UmeLike will operate.

---

## 15. Governing law and disputes

**To be completed with counsel before publication.**

Proposed starting point: the laws of India, with venue and dispute-resolution language chosen after the legal entity, registered/business address, launch jurisdictions, and consumer-law obligations are confirmed.

Do not publish the old `[city]` placeholder.

---

## 16. Changes to these Terms

UmeLike may update these Terms as the service or legal requirements change. The date at the top identifies the current version. Where applicable law requires additional notice, consent, or other steps, UmeLike will provide them.
...
General: **[hello/support email to be confirmed]**  
